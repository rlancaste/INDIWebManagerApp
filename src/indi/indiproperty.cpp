...
void INDI_P::initGUI()
{
    ...
    labelW->setFixedWidth(PROPERTY_LABEL_WIDTH * MainWindow::Instance()->devicePixelRatio());
...
void INDI_P::setupSetButton(const QString &caption)
{
    ...
    setB->setMinimumWidth(MIN_SET_WIDTH * MainWindow::Instance()->devicePixelRatio());
    setB->setMaximumWidth(MAX_SET_WIDTH * MainWindow::Instance()->devicePixelRatio());
