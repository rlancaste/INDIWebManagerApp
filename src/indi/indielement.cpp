...
void INDI_E::buildText(IText *itp)
{
    ...
    {
        case IP_RW:
            setupElementRead(ELEMENT_READ_WIDTH  * MainWindow::Instance()->devicePixelRatio());
            setupElementWrite(ELEMENT_WRITE_WIDTH  * MainWindow::Instance()->devicePixelRatio());

            break;

        case IP_RO:
            setupElementRead(ELEMENT_FULL_WIDTH * MainWindow::Instance()->devicePixelRatio());
            break;

        case IP_WO:
            setupElementWrite(ELEMENT_FULL_WIDTH * MainWindow::Instance()->devicePixelRatio());
            break;
    }
...
void INDI_E::setupElementLabel()
{
    ...
    label_w->setMinimumWidth(ELEMENT_LABEL_WIDTH * MainWindow::Instance()->devicePixelRatio());
    label_w->setMaximumWidth(ELEMENT_LABEL_WIDTH * MainWindow::Instance()->devicePixelRatio());
...
void INDI_E::buildNumber(INumber *inp)
{
    ...
    switch (dataProp->getPermission())
    {
        case IP_RW:
            setupElementRead(ELEMENT_READ_WIDTH * MainWindow::Instance()->devicePixelRatio());
            if (scale)
                setupElementScale(ELEMENT_WRITE_WIDTH * MainWindow::Instance()->devicePixelRatio());
            else
                setupElementWrite(ELEMENT_WRITE_WIDTH * MainWindow::Instance()->devicePixelRatio());
        ...
        case IP_WO:
            if (scale)
                setupElementScale(ELEMENT_FULL_WIDTH * MainWindow::Instance()->devicePixelRatio());
            else
                setupElementWrite(ELEMENT_FULL_WIDTH * MainWindow::Instance()->devicePixelRatio());
...
void INDI_E::setupElementScale(int length)
{
    ...
    if (length == ELEMENT_FULL_WIDTH  * MainWindow::Instance()->devicePixelRatio())
...
void INDI_E::setupBrowseButton()
{
    ...
    browse_w->setMinimumWidth(MIN_SET_WIDTH  * MainWindow::Instance()->devicePixelRatio());
    browse_w->setMaximumWidth(MAX_SET_WIDTH  * MainWindow::Instance()->devicePixelRatio());
